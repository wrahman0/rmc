...
function(RmcBackbone, $, _jqueryui, _, _s, ratings, _select2, _autosize,
  ...
  var UserCourse = RmcBackbone.Model.extend({
    ...
    initialize: function(attrs) {
      ...
      profRatings.on('change', _.bind(
            this.onRatingsChange, this, 'PROFESSOR'));

      courseReview.on('change:comment', _.bind(
          this.onCommentsChange, this, 'COURSE'));
      profReview.on('change:comment', _.bind(
          this.onCommentsChange, this, 'PROFESSOR'));
